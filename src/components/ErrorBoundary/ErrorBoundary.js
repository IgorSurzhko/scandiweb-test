				...
				<div className="error">
					<div>
						...
						<div div className="row">
							Please make a screenshot with a couple of words about this error (when?
							why? and what do you think about Chinese dragons? ), and send it to
							surzhko.igor@gmail.com
						</div>
						<div div className="row">
						...
						<div className="row">
							A fatal exception has occurred at C0DE:ABAD1DEA in 0xC0DEBA5E.
						</div>
